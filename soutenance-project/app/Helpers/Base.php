...
class base
{
    public static function getUserInfo()
    {
        if (Auth::check()) {
            ...
            return [
                'personne' => $personne,
                'domainesIntervention' => $domainesIntervention
            ];
        }
    ...
    public static function recupLogs()
    {
        ...
        if ($user->typePersonne ===  'Patient') {
            ...
            $lesLogs = Log::select('logs.*', 'personnes.nomPers AS personnel_sante_nom', 'personnes.professionPers AS personnel_sante_profes', 'personnes.prenomPers AS personnel_sante_prenom')
            ...
            $lesLogs = Log::select('logs.*', 'personnes.nomPers AS patient_nom', 'personnes.prenomPers AS patient_prenom')
