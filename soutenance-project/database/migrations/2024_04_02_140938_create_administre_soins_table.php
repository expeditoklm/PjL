...
return new class extends Migration
{
    ...
    {
        Schema::create('administre_soins', function (Blueprint $table) {
            $table->id();
            $table->string('libelleSoins');
            $table->string('detailsAdministreSoins');
    ...
    {
        Schema::dropIfExists('administre_soins');
    }
};
