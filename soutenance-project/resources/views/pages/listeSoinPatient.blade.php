          ...
          <table id="toggleButtons" class="table table-striped">
            ...
            @foreach ($soins as $item)
              <tr>
                <td>
                  <div class="card ">
                    <div class="list-group w-auto">
                      <a href="{{route('pages.soin-patient', ['id' =>$item->id ])}}" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                        <img src="assets/images/products/product1.jpg" alt="Bootstrap Gallery" class="rounded-circle flex-shrink-0 img-3x" />
                        <div class="d-flex gap-2 w-100 justify-content-between">
                          <div>
                            <h6 class="mb-0">{{$item->typeSoin->libTypeSoin }}</h6>
                            <p class="mb-0 text-light">
                            {{ $item->detailsAdministreSoins}}
                            </p>
                          </div>
                ...
                <!-- Modal Modification -->
                <div class="modal fade" id="modifSoinPatient" tabindex="-1" aria-labelledby="modifSoinPatientLabel" aria-hidden="true">
                  <div class="modal-dialog modal-fullscreen">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title h4" id="modifSoinPatientLabel">
                          Formulaire de Modification de SoinPatient
                        </h5>
                            ...
                            <div class="col-sm-12">
                              <div class="card mb-3">
                                <div class="card-header">
                                  <h5 class="card-title">Modification de Soin Administré</h5>
                                </div>
                                <form action="">
                                  <div class="card-body">
                                    <!-- Row start -->
                ...
                <!-- Modal suppression -->
                <div class="modal fade" id="supSoinPatient" tabindex="-1" aria-labelledby="supSoinPatientLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title h4" id="addSoinLabel">
          Formulaire d'Enregistrement de Soin Administré
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="modal-body">
          <div class="row gx-3">
            <div class="col-sm-12">
              <div class="card mb-3">
                <div class="card-header">
                  <h5 class="card-title">Enregistrer Soin Administré</h5>
                </div>
                <form action="">
                  <div class="card-body">
                    <!-- Row start -->
