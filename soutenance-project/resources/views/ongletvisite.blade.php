      ...
      <div class="main-container">
        ...
        <nav id="sidebar" class="sidebar-wrapper">
          ...
          <div class="sidebar-container">
            ...
            <div class="sidebar-menu">
              ...
              <a href="widgets.html" class="active" data-bs-toggle="tooltip" data-bs-placement="right"
                data-bs-title="Widgets">
                <i class="ri-pie-chart-line"></i>
              </a>
              <a href="support.html" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Support">
        ...
        <div class="app-container">
          ...
          <div class="app-header d-flex align-items-center">
            ...
            <div class="header-actions">
              ...
              <div class="d-sm-flex d-none">
                ...
                <!-- Settings starts -->
                <a class="dropdown-toggle d-flex" href="account-settings.html" data-bs-toggle="tooltip"
                  data-bs-placement="bottom" data-bs-title="Settings" data-bs-custom-class="custom-tooltip-danger">
                ...
                <!-- Messages starts -->
                <div class="dropdown">
                  <a class="dropdown-toggle d-flex position-relative" href="#!" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
          ...
          <div class="app-hero-header d-flex align-items-center">
            ...
            <!-- Page title starts -->
            <div>
              <a href="index.html" class="mb-1 text-primary d-flex align-items-center">
                <i class="ri-arrow-left-s-line fs-3 lh-1 me-1 ms-n2"></i> Back to home
              </a>
              <h4 class="mb-1 text-primary fw-semibold">UI Widgets</h4>
            </div>
            <!-- Page title ends -->
              ...
              <div class="d-flex align-items-center flex-row flex-wrap">
                ...
                <div class="ms-auto d-flex gap-2">
                  <a href="index.html" class="btn bg-primary-subtle position-relative">
                    ...
                    <span
                      class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">9+</span>
                  </a>
                  <a href="javascript:void(0)" class="btn bg-primary-subtle position-relative">
                    <span>Visites</span>
                    <span
                      class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">8</span>
                  </a>
                  <a href="javascript:void(0)" class="btn bg-primary-subtle position-relative">
                    <span>Analyses</span>
                    <span
            ...
            <div class="row gx-3">
              <div class="card mb-3">
                  <div class="card-header">
                    <h5 class="card-title">Toggle Buttons</h5>
                  </div>
                  <div class="card-body">
                              ...
                              <div class="card ">
                                  <div class="list-group w-auto">
                                    <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true">
                                      <img src="assets/images/products/product1.jpg" alt="Bootstrap Gallery"
